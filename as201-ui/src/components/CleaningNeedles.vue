<template>
  <div class="clearning-needles-div">
    <div class="clearning-needles-div-content">
      <div class="steps">
        <span>
          {{this.$t("language.cleaning_needles_steps_first")}}
        </span>
        <span>
          {{this.$t("language.cleaning_needles_steps_second")}}
        </span>
        <span>
          {{this.$t("language.cleaning_needles_steps_third")}}
        </span>
        <span>
          {{this.$t("language.cleaning_needles_steps_fourth")}}
        </span>
        <span>
          {{this.$t("language.cleaning_needles_steps_fifth")}}
        </span>
      </div>
    ...
    <div class="clearning-needles-warning">
      ...
      {{this.$t("language.cleaning_needles_warning")}}
    </div>
  </div>
</template>
